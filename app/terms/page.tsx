...
const sections = [
  ...
  },
  {
    ...
    content: `서비스 내 표시되는 게임 이미지, 스트리밍 영상, 스트리머 정보, 게임 로고 등 모든 콘텐츠의 저작권은 원작자 및 해당 플랫폼(네이버, Valve, IGDB 등)에 있습니다. Richzem은 이들 회사와 공식적인 제휴·후원·승인 관계에 있지 않으며, 제공하는 정보의 정확성·최신성·신뢰성을 보증하지 않습니다. 서비스 이용 중 발생하는 손해에 대해 운영자는 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.`,
  },
  {
    title: "제6조 (이용자의 의무)",
    items: [
