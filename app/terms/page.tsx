...
const sections = [
  ...
  },
  {
    ...
    content: `본 서비스는 네이버 치지직(CHZZK), Valve Corporation(Steam), IGDB 등 제3자 API를 활용하여 운영됩니다. 해당 외부 플랫폼의 API 정책 변경, 서버 장애, 데이터 불일치 등으로 인해 서비스가 예고 없이 중단되거나 일부 기능이 제한될 수 있으며, 서비스 운영자는 이에 대한 법적 책임을 지지 않습니다. 운영자는 서비스를 상시 개선할 권리를 가지며, 기능의 추가·수정·삭제에 대해 별도로 통지하지 않을 수 있습니다.`,
  },
  {
    title: "제5조 (저작권 및 면책 조항)",
    content: `서비스 내 표시되는 게임 이미지, 스트리밍 영상, 스트리머 정보, 게임 로고 등 모든 콘텐츠의 저작권은 원작자 및 해당 플랫폼(네이버, Valve, IGDB 등)에 있습니다. Richzem은 이들 회사와 공식적인 제휴·후원·승인 관계가 없는 독립 개인 프로젝트이며, 제공하는 정보의 정확성·최신성·신뢰성을 보증하지 않습니다. 서비스 이용 중 발생하는 손해에 대해 운영자는 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.`,
  },
  {
    title: "제6조 (이용자의 의무)",
    items: [
  ...
  },
  {
    ...
    content: `회원 가입은 Google 계정을 통한 소셜 로그인으로 이루어집니다. 회원은 언제든지 서비스 내 '회원 탈퇴' 기능을 통해 계정을 삭제하고 탈퇴할 수 있습니다. 탈퇴 시 회원의 개인정보는 관련 법령이 정한 경우를 제외하고 지체 없이 삭제됩니다.`,
  },
  {
    title: "제8조 (서비스 이용 제한)",
    ...
    <main className="mx-auto max-w-3xl px-4 py-14">
      <div className="mb-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          최종 업데이트: 2026년 4월 1일 &nbsp;·&nbsp; 본 약관은 Richzem 서비스 이용에 관한
          전반적인 조건을 규정합니다.
        </p>
      </div>
