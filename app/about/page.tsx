...
const features = [
  ...
  },
  {
    ...
    title: "게임 상세 콘텐츠",
    description:
      "게임 상세에서 해당 카테고리 라이브 방송 카드(시청자 수·채널 수 요약)와 함께, 치지직 다시보기(VOD)·클립 탭도 제공합니다. 인기 스트리머 TOP3 슬롯과 평가 정보도 함께 표시됩니다.",
  },
  {
    icon: Layers,
    title: "조건부 추천 섹션",
  ...
  },
  {
    ...
    title: "계정·팔로우",
    description:
      "Google 로그인 후 게임·태그·스트리머 팔로우, 다시보기·클립 북마크, 캘린더 일정 팔로우 및 사용자 정의 일정 추가·편집 등 설정을 서버에 저장할 수 있습니다. 비로그인 시 팔로우 탭의 빈 화면 등에는 안내 문구가 표시될 수 있습니다. 좌측 사이드바에는 로그인 여부와 관계없이 실시간 트렌딩·급상승 게임 미니 목록이 제공됩니다. 저장한 영상 일부는 브라우저에도 남을 수 있습니다.",
  },
]
